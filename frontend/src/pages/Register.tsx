...
import { Mail, Eye, EyeOff, User, Lock, Loader2 } from "lucide-react"
...
const Register = () => {
  ...
  const [role] = useState("seeker") // Default role as per user request to focus on job seeker
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              <input type="checkbox" id="terms" required className="mt-1 w-4 h-4 rounded border-border text-primary focus:ring-primary" />
